//
// Ejercicio_2.asm
// Elabora una calculadora con un teclado matricial 4x4 en la cual puedas introducir dos dÌgitos del 0
// al 9 y con las teclas A, B, C y D esos dos dÌgitos puedan ser sumados, restados, multiplicados y
// divididos respectivamente.
// Tanto los resultados como los operandos deben ser desplegados por medio de los LEDs en formato
// binario. TambiÈn puedes mostrar el operador con alguna secuencia para asegurar que leyÛ el botÛn.
